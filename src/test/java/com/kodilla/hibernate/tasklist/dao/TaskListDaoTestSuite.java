...
public class TaskListDaoTestSuite {
    ...
    public void testFindByListName() {
        //Given
        TaskList taskList = new TaskList("Name3", "Description3");

        // When
        taskListDao.save(taskList);
        List<TaskList> taskListFromBase = taskListDao.findByListName("Name3");
        System.out.println(taskListFromBase);
        // Them
        Assert.assertEquals(taskList.getListName(), taskListFromBase.get(0).getListName());

        //CleanUp
        taskListDao.deleteByListName("Name3");
    }
